...
export const BADGES: BadgeDef[] = [
  { id: "first_solve", name: "Pehla Solve", emoji: "🎯", description: "Apna pehla DSA problem solve kiya", category: "dsa", check: (s) => s.dsaSolved >= 1 },
  ...
  { id: "dsa_100", name: "Century", emoji: "💯", description: "100 problems — bhai badhiya!", category: "dsa", check: (s) => s.dsaSolved >= 100 },
  { id: "hard_5", name: "Hard Hitter", emoji: "🔥", description: "5 Hard problems solved", category: "dsa", check: (s) => s.dsaHard >= 5 },

  { id: "first_apply", name: "Pehli Application", emoji: "📮", description: "Pehla job apply kiya", category: "jobs", check: (s) => s.jobsApplied >= 1 },
  { id: "apply_10", name: "Hunter", emoji: "🎯", description: "10 applications bhejin", category: "jobs", check: (s) => s.jobsApplied >= 10 },
  { id: "apply_50", name: "Apply Machine", emoji: "🚀", description: "50 applications — koi to milegi!", category: "jobs", check: (s) => s.jobsApplied >= 50 },

  { id: "focus_first", name: "Focused", emoji: "🧘", description: "Pehla focus session complete kiya", category: "focus", check: (s) => s.focusSessions >= 1 },
